...
/**
 * The class that handles requests regarding general contest
 * information.
 * <p>
...
public class ContestHandler implements RouteTarget {
   ...
   * {@inheritDoc}
   * <p>
   * Accepts requests regarding viewing contests and contest
   * problems. Currently, only serves a static file to
   * indicate that the route is working.
   *

...
/**
 * The class that handles requests regarding specific
 * contest problems.
 * <p>
...
public class ContestProblemHandler implements RouteTarget {
   ...
   * {@inheritDoc}
   * <p>
   * Accepts requests regarding contest problems. Currently,
  ...
  public Response accept(Request req) {
    String body =
      "<html><head><title>a</title></head><body>contest problem</body></html>";
